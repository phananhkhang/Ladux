...
INSERT INTO users (id, email, username, password, full_name, phone, avatar, is_active, created_at) VALUES
                                                                                                       (1, 'admin@ladux.vn', 'admin', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'admin'), 'Quản Trị Hệ Thống', '0901000001', 'https://img.example.com/u01.png', true, '2026-05-01 08:00:00+00'),
                                                                                                       (2, 'quanghuy@ladux.vn', 'quang_huy', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'quang_huy'), 'Trần Quang Huy', '0901000002', 'https://img.example.com/u02.png', true, '2026-05-01 08:05:00+00'),
                                                                                                       (3, 'thuha@ladux.vn', 'thu_ha', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'thu_ha'), 'Lê Thu Hà', '0901000003', 'https://img.example.com/u03.png', true, '2026-05-01 08:10:00+00'),
                                                                                                       (4, 'giabao@ladux.vn', 'gia_bao', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'gia_bao'), 'Phạm Gia Bảo', '0901000004', 'https://img.example.com/u04.png', true, '2026-05-01 08:15:00+00'),
                                                                                                       (5, 'nhatnam@ladux.vn', 'nhat_nam', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'nhat_nam'), 'Võ Nhật Nam', '0901000005', 'https://img.example.com/u05.png', true, '2026-05-01 08:20:00+00'),
                                                                                                       (6, 'khanhlinh@ladux.vn', 'khanh_linh', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'khanh_linh'), 'Đỗ Khánh Linh', '0901000006', 'https://img.example.com/u06.png', true, '2026-05-01 08:25:00+00'),
                                                                                                       (7, 'anhtuan@ladux.vn', 'anh_tuan', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'anh_tuan'), 'Bùi Anh Tuấn', '0901000007', 'https://img.example.com/u07.png', true, '2026-05-01 08:30:00+00'),
                                                                                                       (8, 'thaovy@ladux.vn', 'thao_vy', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'thao_vy'), 'Hồ Thảo Vy', '0901000008', 'https://img.example.com/u08.png', true, '2026-05-01 08:35:00+00'),
                                                                                                       (9, 'duclong@ladux.vn', 'duc_long', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'duc_long'), 'Vũ Đức Long', '0901000009', 'https://img.example.com/u09.png', true, '2026-05-01 08:40:00+00'),
                                                                                                       (10, 'thimai@ladux.vn', 'thi_mai', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'thi_mai'), 'Nguyễn Thị Mai', '0901000010', 'https://img.example.com/u10.png', true, '2026-05-01 08:45:00+00'),
                                                                                                       (11, 'haidang@ladux.vn', 'hai_dang', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'hai_dang'), 'Trịnh Hải Đăng', '0901000011', 'https://img.example.com/u11.png', false, '2026-05-01 08:50:00+00'),
                                                                                                       (12, 'ngocanh@ladux.vn', 'ngoc_anh', 'seed-disabled-' || md5(random()::text || clock_timestamp()::text || 'ngoc_anh'), 'Phan Ngọc Ánh', '0901000012', 'https://img.example.com/u12.png', false, '2026-05-01 08:55:00+00');
...
INSERT INTO product_images (id, product_id, image_url, is_primary) VALUES
                                                                       (1, 1, '/uploads/products/laptop-apple-macbook-air-m3-13.webp', true),
                                                                       (2, 2, '/uploads/products/laptop-gaming-lenovo-legion-5-pro-16.jpg', true),
                                                                       (3, 3, '/uploads/products/laptop-do-hoa-dell-precision-5680.webp', true),
                                                                       (4, 4, '/uploads/products/laptop-van-phong-hp-probook-450-g10.jpg', true),
                                                                       (5, 5, '/uploads/products/laptop-gaming-asus-tuf-gaming-f15.png', true),
                                                                       (6, 6, '/uploads/products/laptop-sinh-vien-acer-aspire-7-a715.jpg', true),
                                                                       (7, 7, '/uploads/products/workstation-msi-creator-z16.jpg', true),
                                                                       (8, 8, '/uploads/products/gaming-cao-cap-razer-blade-16.jpg', true),
                                                                       (9, 9, '/uploads/products/ultrabook-samsung-galaxy-book-4.png', true),
                                                                       (10, 10, '/uploads/products/msi-thin-15-b13uc.webp', true),
                                                                       (11, 11, '/uploads/products/laptop-doanh-nhan-microsoft-surface-laptop-6.png', true),
                                                                       (12, 12, '/uploads/products/acer-aspire-5.jpg', true);
