...
(1, 1, 'https://img.example.com/p1-1.png', true),
(2, 2, 'https://img.example.com/p2-1.png', true),
(3, 3, 'https://img.example.com/p3-1.png', true),
(4, 4, 'https://img.example.com/p4-1.png', true),
(5, 5, 'https://img.example.com/p5-1.png', true),
(6, 6, 'https://img.example.com/p6-1.png', true),
(7, 7, 'https://img.example.com/p7-1.png', true),
(8, 8, 'https://img.example.com/p8-1.png', true),
(9, 9, 'https://img.example.com/p9-1.png', true),
(10, 10, 'https://img.example.com/p10-1.png', true),
