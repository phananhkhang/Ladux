...
export default function DashboardPage() {
  ...
  return (
    <>
      <PageHeader title="Tổng quan vận hành" description="Các chỉ số được tổng hợp trực tiếp từ endpoint phân trang của backend. Không có doanh thu hoặc biểu đồ ước tính." actions={<span className="inline-flex items-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-bold text-emerald-700"><span className="h-2 w-2 animate-pulse rounded-full bg-emerald-500" />Dữ liệu trực tiếp</span>} />
