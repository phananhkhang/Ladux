...
export default function ProductDetailPage() {
  ...
  const imageUrlMutation = useMutation({ mutationFn: () => adminApi.products.addImageUrls(id, [imageUrl.trim()]), onSuccess: () => { toast.success("Đã thêm ảnh"); setImageUrl(""); invalidate(); }, onError: (error) => toast.error(getApiErrorMessage(error)) });
