...
export default function Header({
    ...
    return (
        <header className="sticky top-0 z-50 border-b border-white/10 bg-[#080a0b]/80 text-white backdrop-blur-xl">
            ...
            <div className="border-t border-white/[0.06] bg-black/35 py-4">
                <div className="container mx-auto px-5 sm:px-6 flex flex-col md:flex-row md:items-center justify-between gap-4 text-[16px] text-neutral-300 font-medium">
                    ...
                    <div className="flex flex-wrap items-center gap-x-8 gap-y-3">
                        <button
                            onClick={() => setCurrentView("store")}
                            className={`transition-colors pb-1 hover:text-[#00D492] border-b-2 text-[16px] ${
                                currentView === "store"
                                    ? "text-[#00D492] border-[#00D492] font-semibold"
                                    : "text-neutral-300 border-transparent hover:border-[#00D492]/50"
                            }`}
                        >
                            Trang chủ
                        </button>
                        ...
                        <a
                            href="#"
                            className="transition-colors pb-1 hover:text-[#00D492] border-b-2 border-transparent hover:border-[#00D492]/50 text-neutral-300 text-[16px]"
                        >
                            Blog tech
                        </a>
                        <a
                    ...
                    <div className="flex items-center gap-6 text-[15px]">
                        <div className="flex items-center gap-2.5 group cursor-pointer">
                            <Phone className="w-[18px] h-[18px] text-[#00D492] group-hover:scale-110 transition-transform" />
                            <span className="text-neutral-400 group-hover:text-white transition-colors">
                                Hotline: <strong className="text-white font-medium">0352 060306</strong> (Miễn phí)
                            </span>
                        </div>
                        <span className="text-white/10 hidden sm:inline">|</span>
                        <div className="flex items-center gap-2.5 text-[#00D492] font-semibold">
