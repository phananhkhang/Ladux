    ...
    return (
        <div className="group relative overflow-hidden rounded-2xl border border-white/[0.06] bg-[#121214] p-5 shadow-[0_8px_30px_rgba(0,0,0,0.5)] hover:shadow-[0_12px_40px_rgba(0,212,146,0.1)] hover:border-[#00D492]/40 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between h-full select-none text-white">
            ...
            <button
                ...
                className={`absolute right-4 top-4 z-20 flex h-8 w-8 items-center justify-center rounded-full border transition-all duration-300 ${
                    isWishlisted
            ...
            <div className="cursor-pointer" onClick={() => onSelectProduct(laptop)}>
                ...
                {/* Product Title */}
                <h3 className="font-bold text-[14px] leading-snug line-clamp-2 text-white group-hover:text-[#00D492] transition-colors text-center h-[2.5rem] flex items-center justify-center px-1">
                    {laptop.name}
                </h3>
                ...
                <div className="mt-4 space-y-0.5 text-left pl-1">
                    ...
                    <div className="text-sm font-bold text-[#ff4a4a] flex items-baseline gap-1">
                        <span>Giá Sale:</span>
                        <span className="text-[15px] font-extrabold text-[#ff4a4a]">{formatVND(laptop.discountPrice || laptop.price)}</span>
                        <span className="text-[9px] font-normal text-red-400 shrink-0 ml-0.5">(+ 8% VAT)</span>
                    </div>
                </div>
            </div>
            ...
            <div className="mt-4 pt-3 border-t border-white/[0.05] flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center gap-1 bg-[#00D492] text-black py-1.5 rounded-lg text-xs font-bold hover:bg-[#00bc82] transition-colors"
                    >
